...
The `WORKER_URL` is your deployed Cloudflare Worker endpoint (e.g. `https://octybot-worker.YOUR-SUBDOMAIN.workers.dev`). Without it, hooks run fine but usage/cost data won't appear in the app.
